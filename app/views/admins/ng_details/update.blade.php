...
@section('content')
  <div class="page-header clearfix">
    <h3>
      ...
      <span class="glyphicon-class">UPDATE NG Detail: <i>{{$ng_detail->title}}</i></span>
    </h3>
  </div>
  <div class="row">
    <form enctype="multipart/form-data" role="form" method="POST" action="{{url("admin/ng-detail/{$ng_detail->id}/update")}}">
      {{Form::token()}}
      <div class="col-xs-12">
        ...
        <div class="form-group">
          ...
          <input type="text" name="title" class="form-control" id="title" placeholder="Enter NG Detail title here" value="{{$ng_detail->title}}">
        </div>
        <div class="form-group">
