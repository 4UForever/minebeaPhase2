...
@section('content')
  <div class="page-header clearfix">
    <h3><span class="glyphicon glyphicon-th"></span>
      <span class="glyphicon-class">Import Excel file for NG Detail</span>
    </h3>
  </div>
  <div class="row">
    <form role="form" method="POST" enctype="multipart/form-data" action="{{url("admin/ng-detail/import")}}">
      {{Form::token()}}
      <div class="col-xs-12">
