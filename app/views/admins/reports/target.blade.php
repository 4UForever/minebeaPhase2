...
@section('js')
  @parent
  <script src="{{asset('assets/js/import-target.js')}}"></script>
@stop
...
<div class="row">
  <div class="col-xs-12">
    <ul class="nav nav-tabs">
      <li class="active"><a data-toggle="tab" href="#tab1">Data Target PC &amp; Stock PC</a></li>
      <li><a data-toggle="tab" href="#tab2">Import Target PC &amp; Stock PC</a></li>
    </ul>
    <div class="tab-content">
      ...
      <div id="tab2" class="tab-pane">
        <p>
          <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{url("admin/import-target")}}">
            {{Form::token()}}
